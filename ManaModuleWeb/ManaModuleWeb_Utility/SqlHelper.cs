...
namespace ManaModuleWeb_Utility
{
    public class SqlHelper
    {
        public static readonly string connectionString = ConfigurationManager.ConnectionStrings["ManaModuleWebStr"].ConnectionString;
